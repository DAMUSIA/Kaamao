...
const getCategoryColor = (category: string): string => {
  ...
  return (
    colors[category] || "bg-gradient-to-r from-gray-500 to-gray-600 text-white"
  );
};
...
export default function CreateServicePage() {
  ...
  const [preview] = useState<ServicePreview>({
    ...
    reviewCount: 24,
    description:
      "I provide home and online tuition for Mathematics and Science for classes 6 to 10. Personalized learning and concept clarity is my priority.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-sm text-blue-200 font-light">
                Mumbai, India
              </span>
            </div>
        ...
        <div className="flex gap-8">
          ...
          <div className="flex-1">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/50 p-6 hover:shadow-2xl transition-all duration-300">
                ...
                <div
                  className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-4 mb-6 border border-blue-100"
                  role="note"
                  aria-label="Pricing tip"
                >
                  <p className="text-sm text-blue-800 font-['Inter']">
                    💡 Pricing Tips: Research similar services in your area to
                ...
                <div className="grid grid-cols-2 gap-5">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder={
                        PRICE_TYPES.find(
                          (pt) => pt.value === formData.priceType,
                        )?.placeholder
                      }
                      className="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-200 font-['Inter'] bg-white"
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/50 p-6 hover:shadow-2xl transition-all duration-300">
                ...
                <div className="mb-6">
                  <fieldset>
                    <legend className="block text-sm font-semibold text-gray-700 mb-3 font-['Inter']">
                      Select Days
                    </legend>
          ...
          <aside className="w-80 flex-shrink-0 space-y-6">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/50 p-5 sticky top-24">
              <h3 className="font-semibold text-gray-800 mb-2 text-lg font-['Inter']">
                Service Preview
              </h3>
              ...
              <div className="rounded-xl overflow-hidden shadow-lg">
                ...
                <div className="p-4 bg-white">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <span className="font-semibold text-gray-800 text-sm font-['Inter']">
                        {preview.name}
                      </span>
                      {preview.isVerified && (
                        <CheckCircle
                  ...
                  <h4 className="font-bold text-gray-900 text-sm mb-2 font-['Inter']">
                    {preview.title}
                  </h4>
                  <span
                    className={`inline-block px-2 py-1 rounded-lg text-xs font-semibold ${getCategoryColor(preview.category)}`}
                  >
                    {preview.category}
                  </span>

                  <div className="mt-3">
                    <span className="font-bold text-blue-600 text-lg font-['Inter']">
                      {preview.price}
                    </span>
                  </div>
                  ...
                  <p className="text-xs text-gray-600 mt-3 line-clamp-2 font-['Inter']">
                    {preview.description}
                  </p>
                  ...
                  <div className="mt-3 space-y-1.5 text-xs text-gray-600">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <span className="font-['Inter']">
                        Available: {formatAvailability(preview.availableDays)}
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Clock
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl shadow-lg p-5 border border-blue-100">
              <h3 className="font-semibold text-gray-800 mb-3 flex items-center gap-2 text-lg font-['Inter']">
                <Info size={18} className="text-blue-600" aria-hidden="true" />{" "}
              ...
              <ul className="space-y-3 text-sm">
                <li className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600 mt-0.5">
                      Services with photos get 3x more views
                    </p>
                  </div>
                </li>
                <li className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600 mt-0.5">
                      Explain your service and experience
                    </p>
                  </div>
                </li>
                <li className="flex gap-3">
                ...
                <li className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600 mt-0.5">
                      Verified profiles get more trust
                    </p>
                  </div>
                </li>
              </ul>
              ...
              <div className="mt-5 pt-4 border-t border-blue-200">
                <div className="bg-white/60 rounded-xl p-3">
                  <p className="text-xs text-gray-700 mb-2 font-['Inter']">
                    Need Help? Check our guide to create the best service
                    listing.
                  </p>
